...
class GaussianModel:
    ...
    def setup_functions(self):
        ...
        self._incident_dirs = torch.zeros((100, 3))  # Default to None or an appropriate tensor
        self._incident_areas = torch.ones((100, 1)) # Default to None or an appropriate tensor
        self._visibility_tracing = torch.zeros((100,))  # Default to None or an appropriate tensor
        if self.use_pbr:
